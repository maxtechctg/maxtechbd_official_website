...
- **Smart Scrolling Header**: At the top of the page, the header shows white text on a transparent background. When scrolling down (past 50px), the header becomes fixed with a white background, navigation text changes to #404135 (dark), and hover effects use #CC181F (red) for both menu items and the Contact us button.
