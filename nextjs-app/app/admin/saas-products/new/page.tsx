...
export default function NewSaaSProductPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/admin/saas-products', {
        method: 'POST',
  ...
  return (
    <div>
      <div className="admin-header">
        <h1 className="admin-title">Add SaaS Product</h1>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="admin-card" style={{ marginBottom: '1.5rem' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: '#6c757d', marginBottom: '1rem' }}>Add features that will display as numbered cards with icons (like the screenshot reference)</p>
