  ...
  try {
    ...
    const product = await prisma.saaSProduct.create({
      data: {
        ...
        totalUsers: data.totalUsers?.trim() || null,
        keyFeatures: data.keyFeatures || null,
        pricingPlans: data.pricingPlans || null,
        parallaxTitle: data.parallaxTitle?.trim() || null,
        parallaxDescription: data.parallaxDescription?.trim() || null,
        parallaxImage: data.parallaxImage?.trim() || null,
