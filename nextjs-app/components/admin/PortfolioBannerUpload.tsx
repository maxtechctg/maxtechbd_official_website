  ...
  const handleRemove = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setMessage({ type: 'error', text: data.error || 'Failed to remove banner' });
      }
    } catch (error) {
  ...
  return (
    <div className="admin-card" style={{ marginBottom: '24px' }}>
      ...
      <p style={{ color: '#6b7280', marginBottom: '16px', fontSize: '14px' }}>
        Upload a banner image that will appear in the header section of the Portfolio / Case Studies page.
      </p>
